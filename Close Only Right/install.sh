...
USER_CHROME_CSS_URL="https://github.com/Zonnev/elementaryos-firefox-theme/blob/elementaryos-firefox-theme/close%20only%20right/userChrome.css"
USER_CONTENT_CSS_URL="https://github.com/Zonnev/elementaryos-firefox-theme/blob/elementaryos-firefox-theme/close%20only%20right/userContent.css"
